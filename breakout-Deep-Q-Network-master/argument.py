def add_arguments(parser):
    ...
    parser.add_argument('--update_target', type=int, default=50)#5000
    parser.add_argument('--update_current', type=int, default=4)
    parser.add_argument('--summary_time', type=int, default=25)#2500
    ...
    parser.add_argument('--observe_steps', type=int, default=500)#50000
    parser.add_argument('--explore_steps', type=int, default=10000)#1000000
    parser.add_argument('--max_num_steps', type=int, default=100)#10000
    parser.add_argument('--num_episodes', type=int, default=1000)#100000
    parser.add_argument('--saver_steps', type=int, default=250)#25000
